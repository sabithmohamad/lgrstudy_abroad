          ...
          <div className="row service-pt-pb">
            <div className="col-xl-6 col-lg-6">
              <div className="sd-service-details">
                <h3 className="tp-title-sm service-details-space">How LGR can assist Recruitment Partners
</h3>
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="sd-service-details-paragraph">
                <p className="pb-15">Connect with over 100 colleges with our unique course finding engine to elevate your journey, experience rich commissions, and access a world of opportunity.
.</p>
          ...
          <div className="row">
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="sd-service-details-paragraph">
                ...
                <p>At GR Study Abroad, we're not just a consultancy, we're your partners in shaping academic futures and turning dreams into reality.
                </p>
              </div>
            </div>
          </div>
